...
<dtml-if latestMods>
SELECT
  m.moduleid AS "objectId", m.portal_type, m.version, 'latest' as "reqVersion", m.name, m.created, m.revised, 
  abstract, m.stateid, m.doctype,l.url AS license, m.module_ident AS ident, m.submitter, 
  p.moduleid AS parent_id, p.version AS parent_version,
  m.authors as _authors, m.licensors as _licensors, m.maintainers as _maintainers, m.parentauthors as _parentauthors
